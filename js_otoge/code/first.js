...
const setCanvasSize = () => 
    (cvSize = {
        width: isSP ? window.innerWidth - 16 : VIDEO_SIZE.width,
...
const setRange = () => {
    rectRange = {
        y: (cvSize.height - cvSize.height / 6) | 0,//判定枠の位置
        get width() {
            return cvSize.width / notes.lineSize;
        },
        height: (cvSize.height / 24) |0,//判定枠の幅
        leftSpace: 2,
        get rightSpace(){
    ...
    const accurate = [cvSize.height / 80,//perfect
        cvSize.height / 60,//excellent 40
        cvSize.height / 40,//good 25
        cvSize.height / 25,//normal 18
    ]; 
    inputRange = {
